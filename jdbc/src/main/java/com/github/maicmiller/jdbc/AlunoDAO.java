...
/*
* Classe (Data Access Object)  responsável para acessar o banco e executar as Queries...
* */
public class AlunoDAO {
    ...
    public Aluno getById(int id) {
        ...
        try (Connection conn = ConnectionFactory.getConnection()) {
            //Preparar consulta SQL
            String sql = "SELECT * FROM aluno WHERE id = ?"; // o sinal de '?' é o que será parametrizável...
    ...
    public void create(Aluno aluno) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            //Preparar statement com os parâmetros recebidos
            PreparedStatement stmt = conn.prepareStatement(sql);
            stmt.setString(1 , aluno.getNome()); // para a 1.ª interrogação...
            stmt.setInt(2, aluno.getIdade()); // para a 2.ª interrogação...
            stmt.setString(3 , aluno.getEstado()); // para a 3.ª interrogação...
